  ...
  return (
    ...
    image={CONFIG.SHOW_BACKGROUND ? "/config/images/site3.png" : null}>
      ...
      <s.Container
          flex={1}
          ai="center" jc="center"
          style={{ width: "100%", height: "20%", background:"#0f0f0f"} }
          >
        <img src={"/config/images/logo1.png"} alt={"sa iti bagi pula"} style={{width: "10%", height:"5%"}}></img>

        <s.TextDescription>Copyright © 2022 by Doodle Moose Official. </s.TextDescription>
        </s.Container>
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{width: "85%", height: "85%", padding: 24}}>
          <s.Container flex={1} jc={"center"} ai={"center"} style={{width: "100%", height: "100%"}}>
            <StyledImg alt={"example"} src={"/config/images/example.gif" } style={{ transform: "scaleX(-1)",width: "75%", height: "75%"}} />
            ...
            {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              ...
              <>
                <s.TextTitle
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
                  One Doodle Moose costs  {CONFIG.DISPLAY_COST}{" "}
